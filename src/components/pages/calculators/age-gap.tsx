    ...
    <div className="max-w-5xl mr-auto animate-fade-in">
      ...
      <div className="mt-8 bg-muted/30 p-6 rounded border">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          This rule is a common social guideline used to determine the minimum
          age of a person one could date without it being considered "creepy" or
          socially inappropriate. The formula is:{" "}
